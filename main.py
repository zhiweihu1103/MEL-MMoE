...
from codes.model.lightning_mmoe import LightningForMMoE
from codes.utils.dataset import DataModuleForMMoE
...
if __name__ == '__main__':
    ...
    data_module = DataModuleForMMoE(args)
    lightning_model = LightningForMMoE(args)
